 ...
 */
  ...
  #define E_MANUAL        1
#elif ENABLED(MULTI_MATERIAL_UNIT)
  #define E_STEPPERS      1
  #define E_MANUAL        1
#else
...
// No inactive extruders with MK2_MULTIPLEXER, SWITCHING_NOZZLE or MULTI_MATERIAL_UNIT
#if ENABLED(MK2_MULTIPLEXER) || ENABLED(SWITCHING_NOZZLE) || ENABLED(MULTI_MATERIAL_UNIT)
  #undef DISABLE_INACTIVE_EXTRUDER
#endif

// MK2 Multiplexer or Multi Material Unit forces SINGLENOZZLE
#if ENABLED(MK2_MULTIPLEXER) || ENABLED(MULTI_MATERIAL_UNIT)
  #define SINGLENOZZLE
#endif
